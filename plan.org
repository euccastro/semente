* Novo web
** seguinte task
*** /quill ganha um botom "aplicar" ou "salvar"
*** Quando clicamos "aplicar" ou "salvar", salvamos o texto para mostrar como Quem Somos
**** quando clicamos, chamamos um endpoint do servidor
***** ajax ou sente?
****** já temos sente pronto, nom?
Si, mais hai que mirar ligaçom com Friend.
**** portanto, sacamos o texto de Quem Somos de datomic
