...
return (function (p__9802){
var vec__9803 = p__9802;
var attr = cljs.core.nth.call(null,vec__9803,(0),null);
...
var len__9148__auto___9810 = arguments.length;
var i__9149__auto___9811 = (0);
while(true){
if((i__9149__auto___9811 < len__9148__auto___9810)){
args__9155__auto__.push((arguments[i__9149__auto___9811]));

var G__9812 = (i__9149__auto___9811 + (1));
i__9149__auto___9811 = G__9812;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__9156__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9809){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9809));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9813){
...
var data = map__9814__$1;
var message = cljs.core.get.call(null,map__9814__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9814__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9814__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9816 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9816,goog.events.EventType.CLICK,((function (G__9816,map__9814,map__9814__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9816,map__9814,map__9814__$1,data,message,line,file))
);

return G__9816;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9817){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9821){
...
var messages = map__9822__$1;
var warnings = cljs.core.get.call(null,map__9822__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9822__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9825){
...
var messages = map__9826__$1;
var warnings = cljs.core.get.call(null,map__9826__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9826__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9826,map__9826__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9826,map__9826__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9826,map__9826__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9826,map__9826__$1,messages,warnings,exception))
;
