...
var x__8660__auto__ = (((x == null))?null:x);
var m__8661__auto__ = (sablono.util.to_str[goog.typeOf(x__8660__auto__)]);
if(!((m__8661__auto__ == null))){
return m__8661__auto__.call(null,x);
} else {
var m__8661__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__8661__auto____$1 == null))){
return m__8661__auto____$1.call(null,x);
} else {
...
var x__8660__auto__ = (((x == null))?null:x);
var m__8661__auto__ = (sablono.util.to_uri[goog.typeOf(x__8660__auto__)]);
if(!((m__8661__auto__ == null))){
return m__8661__auto__.call(null,x);
} else {
var m__8661__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__8661__auto____$1 == null))){
return m__8661__auto____$1.call(null,x);
} else {
...
var len__9148__auto___10055 = arguments.length;
var i__9149__auto___10056 = (0);
while(true){
if((i__9149__auto___10056 < len__9148__auto___10055)){
args__9155__auto__.push((arguments[i__9149__auto___10056]));

var G__10057 = (i__9149__auto___10056 + (1));
i__9149__auto___10056 = G__10057;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__9156__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq10054){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10054));
});
...
var vec__10058 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__10060;
var words = seq__10059__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__10061){
var vec__10062 = p__10061;
var k = cljs.core.nth.call(null,vec__10062,(0),null);
var v = cljs.core.nth.call(null,vec__10062,(1),null);
...
return cljs.core.update.call(null,G__10065,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__10065;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__7977__auto__ = x__$1.hasDomain();
