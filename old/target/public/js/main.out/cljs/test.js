...
return cljs.core.assoc.call(null,G__16147,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__16147;
}
});
...
var or__7977__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__9148__auto___16152 = arguments.length;
var i__9149__auto___16153 = (0);
while(true){
if((i__9149__auto___16153 < len__9148__auto___16152)){
args__9155__auto__.push((arguments[i__9149__auto___16153]));

var G__16154 = (i__9149__auto___16153 + (1));
i__9149__auto___16153 = G__16154;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9156__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq16149){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__16150,G__16151,seq16149__$2);
});
...
var file = cljs.core.get.call(null,map__16156__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__16156__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__16156__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__16156,map__16156__$1,file,line,column){
return (function (p1__16155_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__16155_SHARP_));
});})(map__16156,map__16156__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__8934__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__8934__auto__,prefer_table__8935__auto__,method_cache__8936__auto__,cached_hierarchy__8937__auto__,hierarchy__8938__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__7977__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__7977__auto__)){
return or__7977__auto__;
} else {
...
var temp__4657__auto___16158 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___16158)){
var message_16159 = temp__4657__auto___16158;
cljs.core.println.call(null,message_16159);
} else {
}
...
var temp__4657__auto___16160 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___16160)){
var message_16161 = temp__4657__auto___16160;
cljs.core.println.call(null,message_16161);
} else {
}
...
var output_dir = "/home/es/.boot/cache/tmp/home/es/src/semente/3nm/-uzzx0a/public/js/main.out";
var output_dir__$1 = (function (){var G__16162 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16162),"/"].join('');
} else {
return G__16162;
}
})();
...
var temp__4655__auto__ = (function (){var and__7965__auto__ = typeof exception.stack === 'string';
if(and__7965__auto__){
var G__16164 = exception.stack;
var G__16164__$1 = (((G__16164 == null))?null:clojure.string.split_lines.call(null,G__16164));
var G__16164__$2 = (((G__16164__$1 == null))?null:cljs.core.get.call(null,G__16164__$1,depth));
if((G__16164__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__16164__$2);
}
} else {
...
var vec__16165 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__16165,(0),null);
var column = cljs.core.nth.call(null,vec__16165,(1),null);
var vec__16168 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__16168,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__16168,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__16168,(2),null);
...
var m__$1 = (function (){var G__16171 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__16175 = (function (){var G__16174 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__16174);
} else {
return G__16174;
}
})();
...
return cljs.core.vary_meta.call(null,G__16176,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__16180 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__16180,(0),null);
var types = vec__16180;
...
return cljs.core.map.call(null,(function (p__16183){
var vec__16184 = p__16183;
var ns = cljs.core.nth.call(null,vec__16184,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__16184,(1),null);
return ((function (vec__16184,ns,vars__$1){
return (function (){
...
var G__16187 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__16187,G__16187__$1,env,once_fixtures,each_fixtures,vec__16184,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__16187,G__16187__$1,env,once_fixtures,each_fixtures,vec__16184,ns,vars__$1){
return (function (){
var seq__16188 = cljs.core.seq.call(null,vars__$1);
var chunk__16189 = null;
var count__16190 = (0);
var i__16191 = (0);
while(true){
if((i__16191 < count__16190)){
var v = cljs.core._nth.call(null,chunk__16189,i__16191);
var temp__4657__auto___16193 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___16193)){
var t_16194 = temp__4657__auto___16193;
each_fixture_fn.call(null,((function (seq__16188,chunk__16189,count__16190,i__16191,t_16194,temp__4657__auto___16193,v,each_fixture_fn,G__16187,G__16187__$1,env,once_fixtures,each_fixtures,vec__16184,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16194)));
});})(seq__16188,chunk__16189,count__16190,i__16191,t_16194,temp__4657__auto___16193,v,each_fixture_fn,G__16187,G__16187__$1,env,once_fixtures,each_fixtures,vec__16184,ns,vars__$1))
);
} else {
}

var G__16195 = seq__16188;
var G__16196 = chunk__16189;
var G__16197 = count__16190;
var G__16198 = (i__16191 + (1));
seq__16188 = G__16195;
chunk__16189 = G__16196;
count__16190 = G__16197;
i__16191 = G__16198;
continue;
} else {
...
var c__8816__auto__ = cljs.core.chunk_first.call(null,seq__16188__$1);
var G__16199 = cljs.core.chunk_rest.call(null,seq__16188__$1);
var G__16200 = c__8816__auto__;
var G__16201 = cljs.core.count.call(null,c__8816__auto__);
var G__16202 = (0);
seq__16188 = G__16199;
chunk__16189 = G__16200;
count__16190 = G__16201;
i__16191 = G__16202;
continue;
} else {
var v = cljs.core.first.call(null,seq__16188__$1);
var temp__4657__auto___16203__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___16203__$1)){
var t_16204 = temp__4657__auto___16203__$1;
each_fixture_fn.call(null,((function (seq__16188,chunk__16189,count__16190,i__16191,t_16204,temp__4657__auto___16203__$1,v,seq__16188__$1,temp__4657__auto__,each_fixture_fn,G__16187,G__16187__$1,env,once_fixtures,each_fixtures,vec__16184,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16204)));
});})(seq__16188,chunk__16189,count__16190,i__16191,t_16204,temp__4657__auto___16203__$1,v,seq__16188__$1,temp__4657__auto__,each_fixture_fn,G__16187,G__16187__$1,env,once_fixtures,each_fixtures,vec__16184,ns,vars__$1))
);
} else {
}

var G__16205 = cljs.core.next.call(null,seq__16188__$1);
var G__16206 = null;
var G__16207 = (0);
var G__16208 = (0);
seq__16188 = G__16205;
chunk__16189 = G__16206;
count__16190 = G__16207;
i__16191 = G__16208;
continue;
}
} else {
...
});})(each_fixture_fn,G__16187,G__16187__$1,env,once_fixtures,each_fixtures,vec__16184,ns,vars__$1))
);
});})(each_fixture_fn,G__16187,G__16187__$1,env,once_fixtures,each_fixtures,vec__16184,ns,vars__$1))
], null);
